public class BookApp {
    public static void main(String[] args){
        ...
        book_database.get_book("Java1001").get_display_text();
        System.out.println("\n");
        book_database.get_book("Java1002").get_display_text();
        System.out.println("\n");
        book_database.get_book("Orcl1003").get_display_text();
        System.out.println();
        book_database.get_book("Python1004").get_display_text();
        System.out.println("\n");
        book_database.get_book("Zombie1005").get_display_text();
        System.out.println("\n");
        book_database.get_book("Rasp1006").get_display_text();
    }
}
